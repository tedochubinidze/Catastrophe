	...
	<div class="form">
		<div class="everything">
			...
			<div class="next">
				...
				<form name="form1" action="AddProductImageServlet" method="post"
					onsubmit="return validateForm()" enctype="multipart/form-data">
					<br> <br> <font color="black"> <strong>Choose
							Product Image To Upload:</strong></font><br> <br> <input type="file"
						name="image" id="img1" /> <br> <br>
