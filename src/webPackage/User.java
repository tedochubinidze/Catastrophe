...
public class User {
	...
	//This is Constructor For Class User, which opens connection and takes User from DataBase
	...
	public void addPost(Post post) {
		int id = postManager.addPost(post.userID, post.timestamp, post.title,
				post.status, post.attachment, post.type);
		post.ID = id;
	}
